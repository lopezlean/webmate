...
const textDomain = 'webmate';

// Name of the translation file.
const translationFile = 'webmate.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'webmate';

// Where can users report bugs.
const bugReport = 'https://ligrila.conm';

// Last translator Email ID.
const lastTranslator = 'Leandro Emanuel Lopez <leandro@ligrila.com>';

// Team's Email ID.
const team = 'Ligrila Dev <info@ligrila.com>';
